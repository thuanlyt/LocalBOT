...
const requiredText = new Map([
  ...
  ['docs/CHATGPT_PROJECT_CONTEXT.md', ['LocalBOT', 'native', 'headless', 'slash-only', '148/148', 'native:test', '1541307192534241318', 'Blocked', 'LB-GUILD-003', 'LB-MUSIC-019', 'LB-OPS-001', 'LB-RUNTIME-019', 'npm run doctor']],
