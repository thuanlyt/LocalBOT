...
const requiredText = new Map([
  ['README.md', ['127.0.0.1:2901', 'LOCALBOT_CONTROL_ENABLED=true', 'LOCALBOT_CONTROL_HOST=127.0.0.1', 'LOCALBOT_CONTROL_PORT=2901', 'LOCALBOT_RUNTIME_PROFILE', 'slash-only', 'Dark', 'Khởi động cùng Windows', 'Native window là cội nguồn', 'LOCALBOT_MESSAGE_CONTENT_INTENT', 'native:smoke:restart', 'native:smoke:commands', 'native:smoke:crash-recovery', '26 commands', 'LB-OPS-001', 'docs/OPS_SPEC.md']],
  ['README-vi.md', ['LocalBOT', 'slash-only', 'LOCALBOT_RUNTIME_PROFILE', '1541307192534241318', 'qa:headless', 'LB-OPS-001', 'docs/OPS_SPEC.md']],
  ['docs/CHATGPT_PROJECT_CONTEXT.md', ['LocalBOT', 'native', 'headless', 'slash-only', '148/148', 'native:test', '1541307192534241318', 'Blocked', 'LB-GUILD-003', 'LB-MUSIC-019', 'LB-OPS-001']],
  ...
  ['docs/ARCHITECTURE.md', ['127.0.0.1:2901', 'LB-RUNTIME-002', 'LB-RUNTIME-016', 'LB-RUNTIME-017', 'LB-RUNTIME-018', 'LB-OPS-001', 'autostart', 'native executable', 'LOCALBOT_MESSAGE_CONTENT_INTENT', 'last-write-wins', 'slash-only']],
  ...
  ['docs/ROADMAP.md', ['LB-COMMANDS-001', 'LB-COMMANDS-003', 'LB-MUSIC-014', 'LB-MUSIC-017', 'LB-MUSIC-018', 'LB-MUSIC-019', 'LB-OPS-001', 'LB-LOG-008', 'LB-SECURITY-001', 'LB-RUNTIME-016', 'LB-RUNTIME-017', 'LB-RUNTIME-018', 'LB-QA-006', 'LB-QA-007', 'LB-QA-008', 'LB-QA-009', 'LB-QA-010', 'LB-QA-011', 'LB-QA-012', 'LB-QA-013', 'LB-QA-014', 'LB-QA-015', 'LB-QA-016', 'LB-QA-017']],
  ['docs/REMAINING_GAPS.md', ['LB-MUSIC-014', 'LB-MUSIC-016', 'LB-MUSIC-017', 'LB-OPS-001', 'LB-RUNTIME-016', 'LB-RUNTIME-017', 'LB-RUNTIME-018', 'LB-QA-017', 'qa:headless', 'Windows autostart', 'Release trust/signing']],
  ['docs/RELEASE_QA_RUNBOOK.md', ['npm run native:smoke', 'npm run native:smoke:configured', 'npm run native:smoke:music', 'npm run native:smoke:soundcloud', 'npm run native:smoke:restart', 'npm run native:smoke:commands', 'npm run native:smoke:crash', 'npm run native:smoke:crash-recovery', 'npm run qa:headless', 'LB-MUSIC-014', 'LB-QA-017', 'LB-RUNTIME-017', 'autostart']],
  ['docs/AUDIT_LOG_SPEC.md', ['LB-LOG-008', 'before the HTTP success response']],
  ['docs/AUDIT_STATUS.md', ['LB-MUSIC-014', 'LB-MUSIC-016', 'LB-MUSIC-017', 'LB-MUSIC-018', 'LB-MUSIC-019', 'LB-OPS-001', 'LB-COMMANDS-001', 'LB-LOG-007', 'LB-LOG-008', 'LB-SECURITY-001', 'LB-RUNTIME-016', 'LB-RUNTIME-017', 'LB-RUNTIME-018', 'LB-QA-006', 'LB-QA-007', 'LB-QA-008', 'LB-QA-009', 'LB-QA-010', 'LB-QA-011', 'LB-QA-012', 'LB-QA-013', 'LB-QA-014', 'LB-QA-015', 'LB-QA-016', 'LB-QA-017', 'LB-UI-002', 'LB-UI-003', 'LB-GUILD-003', '148/148', 'native:test', 'realAppDataChanged:false']],
